...
class Student:
    ...
    # This part is image labels setting start 
        ...
        f_lb1.place(x=0,y=0,width=1366,height=130)
         ...
         # backgorund image 
        bg1=Image.open(r"C:\Users\rajpa\Documents\Python_Test_Projects\Images_GUI\bg3.jpg")
        ...
        dep_combo["values"]=("Select Department","Data Science")
        dep_combo.current(0)
        ...
        cou_combo["values"]=("Select Course","MSc","BSc")
        cou_combo.current(0)
        ...
        #Class Didvision
        student_div_label = Label(class_Student_frame,text="Class Type:",font=("verdana",12,"bold"),fg="navyblue",bg="white")
        ...
        div_combo["values"]=("Full Time","Part Time")
        div_combo.current(0)
