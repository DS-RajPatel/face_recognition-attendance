...
class Login:
    def __init__(self,root):
        ...
        self.bg=ImageTk.PhotoImage(file=r"C:\Users\rajpa\Documents\Python_Test_Projects\Images_GUI\loginBg1.jpeg")
        
        lb1_bg=Label(self.root,image=self.bg)
        lb1_bg.place(x=35,y=0)

        frame1= Frame(self.root,bg="#002B53")
        frame1.place(x=500,y=170,width=340,height=450)

        img1=Image.open(r"C:\Users\rajpa\Documents\Python_Test_Projects\Images_GUI\log1.png")
...
# =====================Forget window=========================================
    def forget_pwd(self):
        if self.txtuser.get()=="":
            ...
            conn = mysql.connector.connect(username='root', password='1234',host='localhost',database='face_recognition',port=3307)
            mycursor = conn.cursor()
...
# This part is image labels setting start 
        ...
        title_lb2.place(x=450,y=110,width=500,height=25)
