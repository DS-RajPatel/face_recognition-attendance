...
class Register:
    def __init__(self,root):
        ...
        self.bg=ImageTk.PhotoImage(file=r"C:\Users\rajpa\Documents\Python_Test_Projects\Images_GUI\bgReg.jpg")
        
        lb1_bg=Label(self.root,image=self.bg)
        lb1_bg.place(x=0,y=0, relwidth=1,relheight=1)

        frame= Frame(self.root,bg="#F2F2F2")
        frame.place(x=230,y=80,width=900,height=580)
        

        # img1=Image.open(r"C:\Users\rajpa\Documents\Python_Test_Projects\Images_GUI\reg1.png")
        ...
        get_str = Label(frame,text="Registration",font=("times new roman",35,"bold"),fg="#002B53",bg="#F2F2F2")
        get_str.place(x=350,y=80)

        #label1 
        exit_btn=Button(frame,text="Exit",command=self.redirect_to_login,width=9,font=("verdana",12,"bold"),fg="white",bg="Red")
